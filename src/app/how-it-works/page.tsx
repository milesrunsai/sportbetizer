...
export default function HowItWorksPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {[
          {
            ...
            accent: 'text-[#E8A838]',
            bg: 'bg-[#E8A838]/5 border-[#E8A838]/20',
          },
          {
            step: '02',
            ...
            accent: 'text-[#A855F7]',
            bg: 'bg-[#A855F7]/5 border-[#A855F7]/20',
          },
          {
            step: '03',
            ...
            accent: 'text-[#4A9EE8]',
            bg: 'bg-[#4A9EE8]/5 border-[#4A9EE8]/20',
          },
          {
            step: '04',
            ...
            accent: 'text-[#10B981]',
            bg: 'bg-[#10B981]/5 border-[#10B981]/20',
          },
          {
            step: '05',
            ...
            accent: 'text-[#EF4444]',
            bg: 'bg-[#EF4444]/5 border-[#EF4444]/20',
          },
        ].map((item) => (
          <div
            key={item.step}
          ...
          {[
            {
              ...
              color: 'border-[#A855F7]/30 bg-[#A855F7]/5',
            },
            {
              model: 'gpt' as const,
              name: 'GPT',
            ...
            <div key={m.model} className={`border rounded-xl p-5 ${m.color}`}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-slate-500">{m.maker}</div>
                </div>
              </div>
              <div className="text-xs font-semibold text-slate-300 mb-2">{m.style}</div>
      ...
      {/* Why Consensus Works */}
      <div className="bg-[#1a1a2e] border border-[#2d2d50] rounded-xl p-6 mb-16">
        <h2 className="text-xl font-bold text-white mb-4 text-center">Why Consensus Beats Solo</h2>
        <div className="grid sm:grid-cols-3 gap-6 text-center">
          <div>
            <div className="text-3xl font-black text-slate-600 mb-1">1 Model</div>
            <div className="text-sm text-slate-500">Each model alone has blind spots. Claude might miss momentum shifts. GPT might over-index on historical data that no longer applies. Gemini might chase false trends.</div>
          </div>
          <div>
            <div className="text-3xl font-black text-[#4A9EE8] mb-1">2/3 Agree</div>
            <div className="text-sm text-slate-500">When two different analytical approaches reach the same conclusion independently, it significantly reduces the chance of a systematic error. Different methodologies, same answer.</div>
          </div>
          <div>
            <div className="text-3xl font-black text-[#E8A838] mb-1">3/3 Agree</div>
            <div className="text-sm text-slate-500">Full consensus across three fundamentally different approaches — probability, statistics, and momentum — is a strong signal. These picks historically outperform single-model selections.</div>
          </div>
        </div>
      </div>

      {/* Disclaimer */}
      <div className="text-center text-xs text-slate-700 max-w-lg mx-auto">
